class Users::Facebook::ShareController < ApplicationController
  ...
  private
    ...
    def populate_friends
      ...
      friends = friends.select {|fb_friend| current_user.in_the_same_city_fb?(fb_friend) }        if params[:same_city].present? && current_user.cache.exist?(:facebook_friend_locations)
