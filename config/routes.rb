HourschoolV2::Application.routes.draw do
  ...
  match '/pro'                        => 'pages#show', :id => 'start_a_school'
  match '/start_a_school'             => 'pages#show', :id => 'start_a_school'
  match '/get_involved'               => 'pages#show', :id => 'get_involved'

  match '/privacy'                    => 'pages#show', :id => 'privacy'
  match '/terms'                      => 'pages#show', :id => 'terms'
